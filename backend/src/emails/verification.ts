...
<html>
  <head>
    ...
    <style>
      ...
      h1 { margin: 10px 0 0; color: #1c1917; font-family: 'Outfit', 'Segoe UI', system-ui, sans-serif; font-size: 30px; font-weight: 800; line-height: 1.18; letter-spacing: 0; }
      .body { padding: 0 32px 34px; color: #57534e; font-size: 15px; line-height: 1.65; }
      .body p { margin: 0 0 16px; }
      .lead { color: #44403c; font-size: 16px; }
      .btn { display: inline-block; background: #ea580c; color: #ffffff !important; text-decoration: none; padding: 13px 28px; border-radius: 8px; font-weight: 800; font-size: 15px; box-shadow: 0 12px 24px rgba(234, 88, 12, 0.22); }
      .btn:hover { background: #c2410c; }
      .cta { text-align: center; margin: 28px 0; }
      .notice { margin-top: 26px; padding: 16px; background: #fff7ed; border: 1px solid #fed7aa; border-radius: 12px; color: #78716c; font-size: 13px; }
      .fallback { margin-top: 20px; color: #78716c; font-size: 12px; line-height: 1.6; }
      .fallback a { color: #c2410c; word-break: break-all; }
      .footer { max-width: 560px; margin: 18px auto 0; text-align: center; color: #a8a29e; font-size: 12px; line-height: 1.6; }
