...
<html>
  ...
  <body>
    ...
    <div class="wrapper"><div class="card"><div class="header"><div class="brand"><span class="brand-cell"><span class="brand-mark"><img src="${logoUrl}" width="42" height="42" alt="" style="display:block;border:0;" /></span></span><span class="brand-cell brand-gap"></span><span class="brand-cell brand-name">SolarSim</span></div></div><div class="hero"><p class="eyebrow">Password reset</p><h1>Reset your password</h1></div><div class="body"><p class="lead">We received a request to reset your password. Click the button below to choose a new one.</p><div class="cta"><a class="btn" href="${escapedUrl}">Reset Password</a></div><div class="notice">If you did not request a password reset, you can safely ignore this email. Your password will remain unchanged.</div><p class="fallback">If the button does not work, copy and paste this link into your browser:<br /><a href="${escapedUrl}">${escapedUrl}</a></p></div></div><div class="footer">You received this email because a password reset was requested for your SolarSim account.</div></div>
  </body>
</html>`
  }
}
